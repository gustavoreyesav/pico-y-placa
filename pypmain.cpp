...
void fecha::impfecha(void){
	switch(opc){
    case 0: cout << "La fecha ingresada es Domingo"<<endl; break;
...
if(opcmtri == 1 || opcmtri == 2 && opc == 1){
	cout << "Usted tiene pico y placa desde las 07H00am hasta 9H30am y 16H00pm hasta 19H30pm."<<endl;}
